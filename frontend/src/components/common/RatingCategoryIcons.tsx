...
export function CleanlinessIcon({ className = 'w-8 h-8 text-[#222222]' }: { className?: string }) {
  return (
...
export function AccuracyIcon({ className = 'w-8 h-8 text-[#222222]' }: { className?: string }) {
  return (
    <div className={className}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export function CheckInIcon({ className = 'w-8 h-8 text-[#222222]' }: { className?: string }) {
  return (
    <div className={className}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export function CommunicationIcon({ className = 'w-8 h-8 text-[#222222]' }: { className?: string }) {
  return (
    <div className={className}>
      <svg
        viewBox="0 0 32 32"
...
export function LocationIcon({ className = 'w-8 h-8 text-[#222222]' }: { className?: string }) {
  return (
    <div className={className}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export function ValueIcon({ className = 'w-8 h-8 text-[#222222]' }: { className?: string }) {
  return (
    <div className={className}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export function renderRatingCategoryIcon(iconName: string, className = 'w-8 h-8 text-[#222222]') {
  switch (String(iconName || '').toLowerCase()) {
    case 'cleanliness':
    case 'spraybottle':
      return <CleanlinessIcon className={className} />;
    case 'accuracy':
    case 'checkcircle':
      return <AccuracyIcon className={className} />;
    case 'checkin':
    case 'check-in':
    case 'key':
      return <CheckInIcon className={className} />;
    case 'communication':
    case 'messagesquare':
    case 'chatbubble':
      return <CommunicationIcon className={className} />;
    case 'location':
    case 'map':
      return <LocationIcon className={className} />;
    case 'value':
    case 'tag':
      return <ValueIcon className={className} />;
    default:
      return <AccuracyIcon className={className} />;
  }
}
